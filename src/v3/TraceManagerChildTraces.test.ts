...
describe('TraceManager - Child Traces (Nested Proposal)', () => {
  ...
  describe('Basic Child Adoption (F-1, F-2)', () => {
    it('should adopt child trace instead of interrupting parent when child trace name is in adoptAsChildren', () => {
      ...
      console.log('All reports:', reportFn.mock.calls.map(call => ({
        name: call[0].name,
    ...
    it.todo('should interrupt parent trace when child trace name is NOT in adoptAsChildren (existing behavior)')
    
    it.todo('should handle multiple children being adopted by the same parent')
    
    it.todo('should transition parent to waiting-for-children state immediately after completing its own requirements')
  })

  describe('Parent Completion (F-3)', () => {
    it.todo('should transition parent from waiting-for-children to complete when all children finish')
    
    it.todo('should transition parent directly to complete if no children exist when entering waiting-for-children')
    
    it.todo('should maintain parent in waiting-for-children state while any child is still running')
  })

  describe('Parent Interruption Propagation (F-4)', () => {
    it.todo('should interrupt all children with parent-interrupted when parent is interrupted manually')
    
    it.todo('should interrupt all children with parent-interrupted when parent times out')
  ...
  describe('Child Interruption Propagation (F-5, F-6)', () => {
    ...
    it.todo('should interrupt parent with child-interrupted when child is interrupted for other reasons')
    
    it.todo('should NOT interrupt parent when child is interrupted with child-swap reason')
  ...
  describe('Span Forwarding (F-7)', () => {
    it.todo('should forward spans from parent to all running children after processing in parent')
    
    it.todo('should not forward spans to children that have already completed')
    
    it.todo('should handle span forwarding when children are in different states')
  })

  describe('Memory Management (F-8)', () => {
    it.todo('should clear children and completedChildren sets in prepareAndEmitRecording')
    
    it.todo('should not create memory leaks with parent-child references')
  })

  describe('Child Utilities and Scope', () => {
    it.todo('should provide child-scoped utilities that return child as current trace')
    
    it.todo('should handle replaceCurrentTrace in child scope by adopting new trace to parent')
    
    it.todo('should handle child-swap interruption when replacing current child trace')
  })
  ...
  describe('Backward Compatibility (F-9)', () => {
    it.todo('should preserve existing single-trace behavior when adoptAsChildren is not defined')
    
    it.todo('should preserve existing interruption behavior when no adoption occurs')
  })
  ...
  describe('Integration Scenarios', () => {
    ...
    it.todo('should handle child adoption with required spans and matching relations')
  })
})
